...
export default function ListUser() {
    ...
    const loadData = async () => {
        setShowLoading(true);
        await axios.get(`http://localhost:8000/users?email_&user_name_like=${searchText}`)
            // get(`http://localhost:8000/users?user_name_&email_like=${searchText}`)
    ...
    useEffect(() => {
        const delaySearch = debounce(loadData, 1000)//dat do tre cho ham search tinh tu khi bo tay ra kho ban phim
        delaySearch();
